...
//    private TaskExt task;
    ...
    public WindowTask1(Window owner, TaskExtMin taskExt, String title, 
...
//        bindAll(taskScan);
    ...
    private void bindAll(TaskExtMin task) {
...
//            task = taskScan;
        ...
        if (task != null && task.isRunning()) {
            ...
            try {
                ...
                Logger.getLogger(WindowTask1.class.getName()).log(Level.SEVERE, null, ex);
            }

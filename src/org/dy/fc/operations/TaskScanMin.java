 ...
 * @author dubin
 */
public class TaskScanMin extends TaskExtMin<ScanResult>{
    ...
    public TaskScanMin(Window owner, List<FileItem> list) {
//        super(owner);
        this.list = list;
    }
...
//                System.out.println("askException : " + s);
                ...
                Logger.getLogger(TaskScanMin.class.getName()).log(Level.SEVERE, null, ex);

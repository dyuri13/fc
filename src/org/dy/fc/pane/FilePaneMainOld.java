 ...
 * @author yuri
 */
public class FilePaneMainOld extends BorderPane{
    private final ObservableList<FileItem> list = FXCollections.observableArrayList(); //new ArrayList<FileItem>()
    ...
    public FilePaneMainOld() {
        this(Paths.get(System.getProperty("user.home")));
    }
    
    public FilePaneMainOld(URI uri) {
        this(Paths.get(uri));
    }
    
    
    
    public void ls(Path p) {//throws IOException { // with task
                    ...
                    if (Desktop.isDesktopSupported()) {
                        ...
                        if (desktop.isSupported(Desktop.Action.OPEN)) {
                            try {
                                ...
                                Logger.getLogger(FilePaneMainOld.class.getName()).log(Level.SEVERE, null, ex);
...
//        cbr.fireEvent(ke);
    ...
    public void selectFileItem(FileItem fi) {
